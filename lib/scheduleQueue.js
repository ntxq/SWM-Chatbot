...
class ScheduleManager {
  ...
  pushSchedule(data) {
    const schdule = new Schedule(data.time, data.conversationId, data.content, data.alarmPeriod);
    ...
    while (true) {
      ...
      while (this._queue.front().nextAlarmTime <= new Date()) {
        ...
        libKakaoWork.sendMessage({
          ...
          ...formatMessage(progressAlarmMessage,{REMAIN:remainTime, CONENT:schedule.content}),
        });
      }
    }
  }
